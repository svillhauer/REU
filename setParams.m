...
%   [N2 pp_mid] = gsw_Nsquared(SA,CT,pp);
 [N2 pp_mid] = gsw_Nsquared(sRef,tRef,pp);
  ...
  Umax = 0.225*.84/1; %0.225;  
  Wmax = 0.045*1.42857143/8.00*.84/1; %0.045; %%% NEEDS TO BE INCREASED FOR DEEP PYCNOCLINES
...
halfwidth= 30 %50; %25 for default half channel width
